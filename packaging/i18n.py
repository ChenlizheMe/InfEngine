...
_ZH = {
    ...
    "Hub Update Required": "必须更新 Hub",
    "Infernux Hub must be updated to {version} before this version of the engine can be installed.\n\nThe verified update will be downloaded now. Hub will then restart automatically.": "安装此版本的引擎前，必须先将 Infernux Hub 更新到 {version}。\n\n现在将下载经过校验的更新，完成后 Hub 会自动重启。",
