...
_ZH = {
    ...
    "Installed": "已安装",
    "Install": "安装",
    "Preparing Python 3.12": "正在准备 Python 3.12",
    "Preparing Python 3.12 for Infernux Hub": "正在为 Infernux Hub 准备 Python 3.12",
    "A background setup process is extracting an isolated full Python 3.12 runtime under C:\\Users\\Public\\InfernuxHub. Each new project will receive its own copy of this runtime. Your existing Python installations are not used or changed. This window will close automatically when setup finishes.": "后台正在 C:\\Users\\Public\\InfernuxHub 中解压隔离的完整 Python 3.12 运行环境。每个新项目都会获得独立副本，电脑上已有的 Python 不会被使用或改动。准备完成后此窗口会自动关闭。",
    ...
    "The private Python runtime is not ready. Hub will extract its isolated Python 3.12 archive when you choose Install.": "Hub 的专用 Python 运行环境尚未就绪。选择安装后，Hub 只会解压自己携带的 Python 3.12 归档。",
    ...
    "This installer copies Infernux Hub and its isolated Python 3.12 runtime onto your machine. It does not install, upgrade, remove, register, or modify any Python already on your system.": "安装程序只会复制 Infernux Hub 及其隔离的 Python 3.12 运行环境，不会安装、升级、删除、注册或修改电脑上已有的任何 Python。",
    ...
    "Deploying private Python 3.12 runtime...": "正在部署专用 Python 3.12 运行环境……",
    ...
    "Hub Update": "Hub 更新",
    "Check GitHub Releases for a verified Hub update.": "检查 GitHub Releases 中经过校验的 Hub 更新。",
    "Check for Updates": "检查更新",
    "Infernux Hub is up to date.": "Infernux Hub 已是最新版本。",
    "Hub Update Available": "Hub 有可用更新",
    "Infernux Hub {version} is available. Update now?\n\nHub will close, install the verified update, and restart automatically.": "Infernux Hub {version} 已发布，是否立即更新？\n\nHub 将关闭，安装经过校验的更新，然后自动重启。",
