...
class AddComponentTransactionCommand(UndoCommand):
    def __init__(self, object_id: int, type_name: str, *, native_document: Optional[dict] = None, python_instance: Any = None, initializer: Optional[Callable[[Any], None]] = None, invoke_after_deserialize: bool = False, description: str = "") -> None: ...
    @property
