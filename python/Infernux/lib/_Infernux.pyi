...
class InxPointCache:
    ...
    def lookup_index(self, stable_id: int) -> int: ...
    def lookup_indices(self, stable_ids: Any, point_indices: Any) -> None: ...
...
class AssetRegistry:
    ...
    def load_point_cache(self, path: str) -> Optional[InxPointCache]: ...
    def load_point_cache_by_guid(self, guid: str) -> Optional[InxPointCache]: ...
    def get_point_cache(self, guid: str) -> Optional[InxPointCache]: ...
    def begin_load_point_cache_by_guid(self, guid: str) -> AssetLoadTicket: ...
...
class Infernux:
    ...
    def _gpu_particle_event_abi_hash(self, graph_instance_id: int) -> int: ...
    def _gpu_particle_event_domain_serial(self, graph_instance_id: int) -> int: ...
